...
<div class="section map-bg fp-noscroll row">
	<div style="height: 100%" class="col-md-12 text-center content heading">
        ...
        <p><input onclick="window.location.href='register.php'; " type="button" value="Register Now" class="btn solid-btn"></p>
...
<div class="section">
    <div class="content padding-10">
		...
		<p align="center"><input onclick="window.location.href='about.php'; " type="button" value="Know More" class="btn empty-btn"></p>
    ...
    <div class="col-md-4">
        <p align="center"><img width="30%" src="assets/images/icon1.png"></p>
        <p align="center">Opportunity to present in front of renowned researchers</p>
    </div>
    <div class="col-md-4">
        <p align="center"><img width="30%" src="assets/images/icon1.png"></p>
        <p align="center">Cash Prizes worth Rs 1,00,000</p>
        ...
        <p align="center"><input onclick="window.location.href='register.php'; " class="btn solid-btn" type="button" value="Register Now"></p>
